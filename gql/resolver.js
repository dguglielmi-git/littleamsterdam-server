...
const resolvers = {
  Query: {
    ...
    // Not Like
    isNotLike: (_, { idPublication }, ctx) =>
      likeController.isNotLike(idPublication, ctx),
    countNotLikes: (_, { idPublication }) =>
      likeController.countNotLikes(idPublication),

    // Trash
    isTrash: (_, { idPublication }, ctx) =>
      likeController.isTrash(idPublication, ctx),
    countTrash: (_, { idPublication }) =>
      likeController.countTrash(idPublication),
  },
